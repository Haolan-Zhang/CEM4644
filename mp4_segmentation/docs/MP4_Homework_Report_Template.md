...
From Step 3a: for each sheet, the count SAM 3 made from your one *footing* box (found / missed / extra) and the area of the footings you boxed against the sizes their marks give. One sheet asks you only to count, because its pile caps are too small to measure - what happens to the measured area of something that small, and why? Then from Step 3b: does *footing* find anything? Which shape word finds the footings, on which sheet, with how many extras, and how do the areas it measures compare with the ones from your boxes? Did any phrase find the pile caps?
