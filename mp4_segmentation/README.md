...
Everything is in feet and square feet. **The scale is set by the student** on every sheet, from a printed dimension
or from something whose size the sheet states; the homework uses that box but prints no SCALE CHECK lines. There is no training exercise
