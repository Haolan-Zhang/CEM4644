...
| [`mp4_segmentation/`](mp4_segmentation/) | MP4 · Segmentation for quantity take-off on floor plans (SAM 3 on real CubiCasa5K plans: rooms, fixtures and openings by name; scale, areas and counts with boxes, checked against each plan's answer key). No-code Colab notebooks for the workshop and the homework, plus the hidden helper code, plans, precomputed masks and instructor guide. |
