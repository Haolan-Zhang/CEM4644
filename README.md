...
| [`mp4_segmentation/`](mp4_segmentation/) | MP4 · Segmentation for progress and quantity measurement (SAM 3 prompted by phrase: material shares of site photos, time series, error analysis, footing take-off on plans). No-code Colab notebooks for the workshop and the homework, precomputed masks, instructor guide. |
